...
theme.weather = lain.widget.weather({
    city_id = 112931, -- placeholder (Belgium)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            arrow("alpha", "#34495e"),
            wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, 3, 6), "#34495e"),
            arrow("#34495e", "#474787"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#474787"),
            arrow("#474787", "#34495e"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#34495e"),
            arrow("#34495e", "#474787"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#474787"),
            arrow("#474787", "#34495e"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, 4, 4), "#34495e"),
            arrow("#34495e", "#474787"),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#474787"),
            arrow("#474787", "#34495e"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#34495e"),
            arrow("#34495e", "#474787"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#474787"),
            arrow("#474787", "#34495e"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#34495e"),
            arrow("#34495e", "alpha"),
            --]]
            s.mylayoutbox,
        },
