...
# Idempotent Firefox hardening/minimalism script
# Target: Arch Linux dotfiles
# Keeps Firefox Sync intact, disables unnecessary features.
...
TARGET="${PROFILE_DIR}/${PROFILE}/${USER_JS}"

# Create/overwrite user.js with minimal prefs
cat >"$TARGET" <<'EOF'
...
echo "✔ Firefox minimal config written to: $TARGET"
